...
const Input = props => {
    ...
    const element = props.element === 'input' ? 
        ...
        return <div className={`form-control form-floating-label ${!inputState.isValid && inputState.isTouched && 'form-control--invalid'}`}>
            {element}
            <label htmlFor={props.id} className={ inputState.value && 'filled'}>{props.label}</label>
